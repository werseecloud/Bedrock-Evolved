...
export const PERFORMANCE_PROFILES = Object.freeze({
  performance: {
    LOD_SCAN_INTERVAL_TICKS: 60,
    LOD_MAX_ACTIVE_IMPOSTORS_PER_PLAYER: 12,
    LOD_MAX_STRUCTURE_PLACEMENTS_PER_MINUTE: 4,
  ...
  balanced: {
    LOD_SCAN_INTERVAL_TICKS: 40,
    LOD_MAX_ACTIVE_IMPOSTORS_PER_PLAYER: 32,
    LOD_MAX_STRUCTURE_PLACEMENTS_PER_MINUTE: 10,
    LOD_NEAR_RADIUS_CHUNKS: 16,
    LOD_DISTANT_RADIUS_CHUNKS: 32,
    LOD_SKYLINE_RADIUS_CHUNKS: 64,
    LOD_BLOCK_OPS_PER_TICK: 64
  ...
  cinematic: {
    LOD_SCAN_INTERVAL_TICKS: 30,
    LOD_MAX_ACTIVE_IMPOSTORS_PER_PLAYER: 64,
    LOD_MAX_STRUCTURE_PLACEMENTS_PER_MINUTE: 18,
  ...
  server: {
    LOD_SCAN_INTERVAL_TICKS: 80,
    LOD_MAX_ACTIVE_IMPOSTORS_PER_PLAYER: 8,
    LOD_MAX_STRUCTURE_PLACEMENTS_PER_MINUTE: 4,
    LOD_NEAR_RADIUS_CHUNKS: 8,
    LOD_DISTANT_RADIUS_CHUNKS: 14,
    LOD_SKYLINE_RADIUS_CHUNKS: 22,
    LOD_BLOCK_OPS_PER_TICK: 24
  }
});
...
export const setLodPerformanceMode = setPerformanceMode;
